...
// corn jobs
// // Schedule to run once a day at midnight (for `updateTodayEventStatus` and `updateCompletedEventStatus`)
// cron.schedule("0 0 * * *", () => {
...
app.get('/',(req, res)=>{
  res.status(200).send(`clothing exchange server in running`)
})
// v1 api routes
